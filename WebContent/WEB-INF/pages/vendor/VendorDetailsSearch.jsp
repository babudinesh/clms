...
<div id="vendorDetails_App" ng-app="vendorDetails_app" ng-controller="vendorDetails_Controller">
    ...
    <div class="container-fluid" style="margin-bottom: 35px;">
        <div style="display: inline-block">
            <h3 class="cls_plainheader">Vendor Details</h3>
        </div>
    ...
    <div class="container-fluid">
        <div class="col-md-10 col-md-offset-1 well">
            ...
            <div class="col-md-12">
               <a class="btn btn-primary pull-right">Add New Vendor <i class="fa fa-plus-circle"></i></a>
                <br />
                <br />
                <br />
                <div class="panel panel-default">
                    <div class="sepr">
                        <h5 class="cls_plainheader">Search Vendors</h5>
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select id="customerName" class="form-control" ng-model="customerName" name="customerName" 
                                           ng-change="fun_customerNameChange()"  ng-required="true" ng-disabled="readOnly">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                       <select id="companyName" class="form-control" ng-model="companyName" name="companyName" 
                                        ng-required="true" ng-disabled="readOnly" ng-change="fun_companyNameChange()">
											<option ng-repeat="z in companyList" value="{{z.id}}">{{z.name}}</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    <label for="vendorName" class="col-md-4 control-label">Vendor Name</label>
                                    <select id="vendorName" class="form-control" ng-model="vendorName" name="vendorName"  ng-required="true" ng-disabled="readOnly">
                                            <option ng-repeat="z in vendorList" value="{{z.id}}">{{z.name}}</option>                                            
                                        </select>
                                </div>

                                <div class="form-group">
                                    <label for="serBy" class="col-md-4 control-label">Search By</label>
                                    <div class="col-md-8">
                                       <select class="form-control" id="serBy">
                                           <option>
                                               Status
                                           </option>
                                            <option>
                               ...
                               <a class="btn btn-primary col-md-3 col-md-offset-5" ng-click="fun_searchGridData($event)">Search <i class="fa fa-search"></i></a>
                                <a class="btn btn-warning col-md-3" ng-click="fun_clearSearchFields($event)">Clear <i class="fa fa-times"></i></a>
                            </div>
                 ...
                 <div class="panel panel-default">
                    <div class="sepr">
                        <h5 class="cls_plainheader">Search results</h5>

							<div class="container-fluid "
								style="margin-bottom: 35px; margin-top: 35px; padding-left: 20%; padding-right: 20%">

								<div class="well">
									<table id="vendorDetailsTable" class="display vendorDetailsTable" cellspacing="0"
										width="100%">
										<thead>
											<tr>
												<th></th>
