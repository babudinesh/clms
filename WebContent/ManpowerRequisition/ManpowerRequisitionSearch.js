...
var ManpowerRequestController = angular.module("myApp.ManpowerRequest", []);

var ManpowerSearchTable;
ManpowerRequestController.controller("ManpowerSearchCtrl",  ['$scope', '$rootScope', '$http', '$resource','$location','myservice','$cookieStore', '$filter', function($scope,$rootScope,$http,$resource,$location,myservice,$cookieStore, $filter) {
		      		                     ...
		      		                     "columns": [
		      		                        { "data": "requestCode" ,
		      		                        	"render": function ( data, type, full, meta ) {                 		                    		 
			               		                      return '<a href="#/addManpowerRequest/'+full.manpowerRequisitionId+'">'+data+'</a>';
			               		                  }
		      		                        },
		      		                        { "data": "employeeName" },
		      		                        { "data": "locationName" },
