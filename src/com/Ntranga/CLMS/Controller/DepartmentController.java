...
public class DepartmentController {
	 ...
	 */
	@RequestMapping(value = "/validateDeptCode.json", method = RequestMethod.POST)
	public String validateDepartmentCode(@RequestBody DepartmentVo paramDepartment) throws JSONException {
		log.info("Entered in Department Controller validateDepartmentCode() ::  "+paramDepartment);
		String returnString = null;
		try{
		List<DepartmentVo> deptList = departmentService.getDepartmentsListBySearch(paramDepartment);
		log.debug("List of Deartments : "+deptList);
		...
		log.info("Exiting from Department Controller validateDepartmentCode() ::  "+returnString);
		return returnString;
	}
