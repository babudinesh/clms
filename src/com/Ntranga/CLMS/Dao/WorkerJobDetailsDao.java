...
public interface WorkerJobDetailsDao {

	
	public List<WorkJobDetailsVo> getSearchGridData(Integer customerId, Integer companyId, Integer vendorId, String workerId, String workerName,  String isActive);
